            ...
            >
              ...
              <div className={`bg-[#10151c] rounded-xl overflow-hidden border border-thin-separator ${isFullscreen ? 'fixed inset-0 z-50 rounded-none' : ''}`}>
                <div className="relative aspect-video bg-black">
                  <Image
                    src="https://static.wixstatic.com/media/f28cb7_7afaa03d42364bbdb858abf94260a958~mv2.png?originWidth=1920&originHeight=1024"
                    alt="Live UAV Feed"
                  ...
                  <div className="absolute top-4 left-4 right-4 flex items-center justify-between">
                    <div className="flex items-center gap-2 bg-primary/20 backdrop-blur-sm px-3 py-2 rounded-lg border border-primary">
                      ...
                      <span className="text-xs font-heading text-primary-foreground">LIVE FEED</span>
                    </div>
                    ...
                    {isRecording && (
                      ...
                      >
                        ...
                        <span className="text-xs font-heading text-destructive-foreground">RECORDING</span>
                      </motion.div>
                    )}
                  </div>
